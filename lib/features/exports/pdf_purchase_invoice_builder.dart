            ...
            pw.Directionality(
              ...
              child: pw.Column(
                ...
                children: [
                  ...
                  pw.SizedBox(height: 4),
                  pw.Text(
                    'حالة الدفع: ${purchase.paymentMode.labelAr} — طريقة السداد: ${purchase.paymentMethod?.labelAr ?? 'غير محددة'}',
                    style: style,
                  ),
                    ...
                    data: [
                      [
                        ...
                        MoneyUtils.formatPiastersAsEgp(
                            purchase.unitPricePiastersPerKg),
                        MoneyUtils.formatPiastersAsEgp(
                  ...
                  if (purchase.notes != null &&
                    ...
                    pw.SizedBox(height: 12),
                    pw.Text('ملاحظات: ${purchase.notes}', style: style),
                  ],
