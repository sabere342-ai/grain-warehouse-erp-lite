...
| 3 | سجل الملاحظات | جميع الملاحظات والأعطال | جزئي — ملاحظتان ما قبل الجلسة (F-001, F-002) | CLIENT-DEMO-FINDINGS-REGISTER-AR.md |
...
| 6 | Checksums الحزمة | التحقق من سلامة الحزمة المستخدمة | PASS — 22/22 | checksums.sha256 |
...
| 12 | شجرة العمل | حالة شجرة العمل أثناء بدء الجlسة | موثق — نظيفة (F-001 محلّل، F-002 محلّل) | git status |
...
*تم تحديث الحزمة إلى ghalal-demo-v1.0.0-20260726-012039 (تصحيح المصدر)*
