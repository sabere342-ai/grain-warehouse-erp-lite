...
- إضافة صنف ومراجعته.
- إضافة مورد.
- تسجيل شراء أو إدخال كمية.
- تسجيل بيع بسعر مسموح.
- التأكد من رفض البيع بسعر أقل من الحد الأدنى.
- إضافة عميل تجريبي.
- إضافة مصروف تجريبي.
- مراجعة تقرير اليوم.
- إنشاء نسخة احتياطية وفحصها.

ما الذي لا يتم دعمه حاليا:
- لا توجد أرصدة عملاء آجلة حتى الآن.
- لا توجد تحصيلات أو مديونية عملاء حتى الآن.
- لا يوجد تعديل أو إلغاء مصروفات حتى الآن.
- لا توجد نسخة سحابية أو متعددة الفروع في هذه النسخة.
