...
void main() {
  ...
  test('Q11 application boundary contains one concrete production query slice',
      () {
    ...
    expect(
      queryFiles.single.path.replaceAll('\\', '/'),
      endsWith('lib/application/queries/load_audit_logs_query.dart'),
    );
  });
}
