...
- حسابات الموردين (كشف حساب، دفعات).
- إدارة المخزون.
- أرصدة العملاء والموردين محسوبة من الحركات (لا يوجد تعديل يدوي).
- تقارير يومية تشمل البيع الآجل والتحصيلات والأرصدة المستحقة.
- نسخ احتياطي واسترجاع.

ما زال غير متوفر حاليا:
- الأرصدة الافتتاحية غير مدعومة بعد - الرصيد يبدأ من أول حركة.
