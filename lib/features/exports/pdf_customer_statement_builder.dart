...
class PdfCustomerStatementBuilder {
  PdfCustomerStatementBuilder._();
  ...
  static Future<Uint8List> build({
    ...
    final documentDate = generatedAt ?? DateTime.now();
            ...
            pw.Directionality(
              ...
              child: pw.Column(
                ...
                children: [
                  ...
                  pw.Text(
                    '$customerName \u2014 \u062c\u0645\u064a\u0639 \u0627\u0644\u062d\u0631\u0643\u0627\u062a \u0627\u0644\u0645\u062a\u0627\u062d\u0629',
                    style: boldStyle,
                  ),
                  pw.Text(
                    '\u0627\u0644\u062a\u0627\u0631\u064a\u062e: ${_formatDate(documentDate)}',
                    style: style,
                  ),
                        ...
                        return [
                          ...
                          entry.debitAmountQirsh > 0
                              ? MoneyUtils.formatPiastersAsEgp(
                                  entry.debitAmountQirsh)
                              : '',
                          entry.creditAmountQirsh > 0
                              ? MoneyUtils.formatPiastersAsEgp(
                                  entry.creditAmountQirsh)
                              : '',
                          MoneyUtils.formatPiastersAsEgp(
